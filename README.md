...
This repository contains all code and derived data necessary to reproduce the analyses, figures, and tables for the paper published in Ornithological Applications:
