...
### some things are coded out because they take a long time to run and they produce saved files. If you want to run them just remove the "#" from them when you run script.
